...
const LanguageModal = () => {
  ...
  return (
    ...
    <>
      ...
      <div className="h-screen flex flex-col justify-center items-center max-md:flex max-sm:flex">
        <Modal
          isOpen={modalIsOpen}
        ...
        >
          ...
          <button onClick={() => changeLanguageSelect("ଓଡ଼ିଆ")} className="text-left pl-8 text-xl h-24 w-100 hover:bg-slate-700">
            <div className="font-bold">ଓଡ଼ିଆ</div>
